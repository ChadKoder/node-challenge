...
var responseService = require('./js/functions/responseService.js');
var authentication = require('./js/functions/authentication.js');
var sorter = require('./js/functions/sorter.js');
var paginator = require('./js/functions/paginator.js');
var configPageObjCreator = require('./js/functions/configPageObjCreator');
...
var router = require('./js/functions/router.js')(path, fs, url, currentWorkingDir, configPgObjectCreator, auth, resService, userConfigs, Buffer);
//router.init(path, fs, url, currentWorkingDir, configPgObjectCreator, auth, resService, userConfigs, Buffer);
var httpHandler = require('./js/functions/httpHandlerService')(path, currentWorkingDir, userConfigs, auth, router, resService);
